...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Surprise Test Question Management</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                                    ...
                                    <div class="col-md-4">
                                         <label>Surprise Test  </label>
                                            <select name="surprise_test" id="surprise_test_id" class="form-control" required>
                                                <option value="0">Select Surprise Test</option>
                                                <?php
                                                $object->query = " SELECT * FROM tbl_exam_master WHERE exam_category = 3 AND status = 4 ";
    	...
    	<form method="post" id="exam_subject_question_form">
      		<div class="modal-content">
        		...
        		<div class="modal-footer">
          			<input type="hidden" name="exam_id" id="qexam_id" />
...
<script>
    function showExamQstions(){
        let exam_id = $('#surprise_test_id').val();
        ...
        var dataTable = $('#exam_subject_question_table').DataTable({
            ...
            "order" : [],
            "ajax" : {
                url:"surprise_test_question_action.php",
                type:"POST",
                data:{action:'fetch',syllabus_id:syllabus_id,paper_id:paper_id,exam_category:3}
            },
            "column":[
                {
                    "targets":[3, 4, 5, 6, 7, 8],
