    ...
    <section class="header" style="display: block;height:122px;background-color: #fff;">
        <div class="header-wrap d-flex justify-content-between">
            ...
            <div class="header-top top d-flex">
                <div class="header-logo logo" style="margin: 10px;">
                  
                    <img src="assets/images/logo-odisha.png" style="height:80px;">
                </div>
                    ...
                    <div class=""><br>
                        <a href="index-2.html" style="text-decoration: azure;">
                            <h1
                               ...
                               Finance Department <br> Circular Mangement System </h1>
                        </a>
                    </div>
            ...
            <div class="header-logo logo d-flex cm">
                ...
                <div>
                    <img src="assets/images/cm.png" style="height:120px;margin-right:10px">
                </div>
