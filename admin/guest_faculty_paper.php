                            ...
                            <div class="modal-dialog">
                                <div class="modal-content" style="width:100%; margin:20px ">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="termModalLabel">Guest Faculty Paper</h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary" name="submit" value="Save"
                                            id="save"
                                            onclick="add('Paper','frm_term','tbl_guest_paper')">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                               <div class="row">
                                    <div class="col-md-4">  
                                       <h4 class="card-title">Guest Faculty Paper</h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div id="term2" class=" table table-responsive table-striped table-hover" style="width:55%;margin:0px auto" >
                               ...
                               $db = new Database();
                               $count = 0;
                               $db->select('tbl_guest_paper',"*",null,'status = 1',null,null);
...
function cnfBox(id) {
    ...
    $('#m_footer').empty();
    var html =
        `<input type="button" class="btn btn-danger btn-dlt" value="Delete" onclick="delete_record(${id},'tbl_guest_paper')" />`;
