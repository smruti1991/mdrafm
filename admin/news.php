                                ...
                                <div class="row" style="margin-top:20px;">
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <div class="col-md-2" style="float:right">
                                        ...
                                        onclick="add('Other Program','program','tbl_news')"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div id="term2" class=" table table-responsive table-striped table-hover" style="width:85%;margin:0px auto" >
                               ...
                               $count = 0;
                               $db->select('tbl_news',"*",null,null,null,null);
  ...
  $('input[type="checkbox"]').on('change', function() {
      ...
      //var checkedValue = $(this).prop('checked');
         ...
         $.ajax({
             ...
             data:{'action':'update_new','update_id':id,'tbl':'tbl_news','new_value':new_msg},
...
function cnfBox(id) {
    ...
    $('#m_footer').empty();
    var html =
        `<input type="button" class="btn btn-danger btn-dlt" value="Remove" onclick="remove_doc(${id})" />
        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">`;
