                            ...
                            <div class="modal-dialog">
                                <div class="modal-content" style="width:200%; margin:20px -150px">
                                    <div class="modal-header">
                                        ...
                                        <h5 class="modal-title" id="termModalLabel"> Modify Time Table
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="post" id="frm_timeTable">
                                            <input type="hidden" name="program_id"
                                                value="<?php echo $_POST['program_id'] ?>" />
                                            <input type="hidden" name="table_range_id"
                                                value="<?php echo $_POST['tbl_id'] ?>" />
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-3" id="break_fld" style="display:none">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select mr-sm-2" name="break_time"
                                                            id="break">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="class_start_time"
                                                            id="timepicker_start" />
                                                        <p id='start_time' style="display:none"></p>
                                                        <span> <button type="button" id="verify_start"
                                                                onclick="verify_time('start_time')" class="btn btn-sm"
                                                                style="background-color:#141664">Verify Class
                                                                Time</button></span>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span> <button type="button" id="verify_end"
                                                                onclick="verify_time('end_time')" class="btn btn-sm"
                                                                style="background-color:#141664">Verify Class
                                                                Time</button></span>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 class_room">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check form-check-inline"
                                                                style="margin-left: 20px;">
                                                                <input class="form-check-input" type="radio"
                                                                    name="faculty" id="inHouse" value="1">
                                                                <label class="form-check-label" for="Inhouse"
                                                                    style="padding-left: 5px;">Inhouse Faculty</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="faculty" id="guest" value="2">
                                                                <label class="form-check-label" for="Visiting"
                                                                    style="padding-left: 5px;">Visiting Faculty</label>
                                                            </div>
                                                            <select class="custom-select mr-sm-6 faculty_id_div"
                                                                name="faculty_id[]" multiple="multiple" id="faculty_id"
                                                                style="width:400px">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select mr-sm-2"
                                                                    id="detail_topic_id" name="detail_topic_id">
                                            ...
                                            <!-- end class room -->
                                            <input type="hidden" name="trng_type" value="<?php echo $_POST['type'] ?>">
                                    ...
                                    <table class=" term table">
                                        <thead class="" style="background: #315682;color:#fff;font-size: 11px;">
                                            ...
                                            <?php  
                                              $session_count = 0;
                                              //print_r($_POST);
                                              $db->select('tbl_time_table',"MAX(session_no) as session",null,"table_range_id = '".$_POST['tbl_id']."' AND program_id = '".$_POST['program_id']."'  AND training_dt = '".$t_date."' ",null,null);
                                        ...
                                        <tbody>
                                            ...
                                            $count = 0;
                                            $db->select('tbl_time_table',"DISTINCT training_dt",null,"table_range_id = '".$_POST['tbl_id']."' AND trng_type ='".$_POST['type']."' ",null,null);
                                            // print_r( $db->getResult());
                                            foreach($db->getResult() as $row){
                                                //print_r($row);
                                                $count++
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                   for ($x=1; $x <= $session_count ; $x++) { 
                                                    $db->select('tbl_time_table',"*",null,"table_range_id = '".$_POST['tbl_id']."' AND trng_type = '".$_POST['type']."' AND training_dt='".$row['training_dt']."' AND session_no = '".$x."' ",null,null); 
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            res.map((data) => {
                    ...
                    if (data.trng_type == 1 || data.trng_type == 2) {
                        $('#term_id').val(data.term_id);
                        $('#paper_id').val(data.paper_id);
                        $('#subject_id').val(data.subject_id);
                        $('#topic_id').val(data.topic_id);
                    } else if (data.trng_type == 3) {
                        //console.log(123);
                        $('#mid_subject_id').val(data.subject_id);
                    }
