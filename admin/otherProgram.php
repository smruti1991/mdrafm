                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div id="term2" class=" table table-responsive table-striped table-hover" style="width:85%;margin:0px auto" >
                               ...
                               $count = 0;
                               $db->select('tbl_other_program',"*",null,null,null,null);
  ...
  $('input[type="checkbox"]').on('change', function() {
      ...
      //var checkedValue = $(this).prop('checked');
         ...
         $.ajax({
             ...
             data:{'action':'update_new','update_id':id,'tbl':'tbl_other_program','new_value':new_msg},
...
function add(str, frm, tbl) {
   ...
   // var form_data = new FormData();                  
    ...
    fd.append('tbl','tbl_other_program');
