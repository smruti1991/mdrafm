                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <?php
                                            ...
                                            $db->select('tbl_new_recruite','DISTINCT(batch_id),fin_status',"batch_id =".$_POST['id']);
                              ...
                              ?>
                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          ...
                                          $db->select('tbl_batch_master',"id,cover_latter",null,"id =".$_POST['id'],null,null);
                                          foreach($db->getResult() as $row){
                                             // print_r($row);
                                              ...
                                              if($row['cover_latter'] == ''){
                                                  ...
                                                  ?>
                                                    <div class="col-md-6" id="latter_doc">
                                     ...
                                     <div class="col-md-3">
                                     <input type="button" class="btn btn-primary "  <?php if ( $fin_status == 1){ echo "disabled"; } ?>
