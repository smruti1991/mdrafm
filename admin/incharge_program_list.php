                                                                        ...
                                                                        <div class="div">
                                                                           ...
                                                                           $db->select_sql($sql);
                                                                            ...
                                                                            foreach($db->getResult() as $row1){
                                                                                //print_r($row1);
                                                                               $cd_id = $db->getCourseDirector($row['course_director']);
                                                                               $asst_cd_id = $db->getAsstCourseDirector($row['course_director']);
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    onchange="add_course_dir(<?php echo $row['id'] ?>,<?php echo $row['course_director'] ?>,<?php echo $row1['trng_type'] ?>,8)">
                                                                                                    ...
                                                                                                    <option
                                                                                                        ...
                                                                                                        <?php echo ($row6['id'] == $cd_id)?'selected':'' ?>>
                                                                                                        <?php echo $row6['name'] ?>
                                                                                                    </option>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-md-8 ">
                                                                                                    ...
                                                                                                    <select
                                                                                                        ...
                                                                                                        style="height: calc(1em + 0.75rem + 2px);padding:0px"
                                                                                                        onchange="add_asst_course_dir(<?php echo $row['id'] ?>,<?php echo $db->getAsstCourseDirector($row['course_director']) ?>,<?php echo $row['course_director'] ?>,13)">
                                                                            ...
                                                                            <div class="row">
                                                                               <div class="col-md-6">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-8 text-left">
                                                                                            <?php if ($cd_id != 0) {
                                                                                                                    $db->select_one('tbl_faculty_master', 'name',$cd_id);
                                                                                                                    foreach ($db->getResult() as $faculty) {
                                                                                                                        echo $faculty['name'];
                                                                                                                    }
                                                                                                                } ?>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-8 text-left">
                                                                                        <?php if ($asst_cd_id != 0) {
                                                                                                                    $db->select_one('tbl_faculty_master', 'name',$asst_cd_id);
                                                                                                                    foreach ($db->getResult() as $faculty) {
                                                                                                                        echo $faculty['name'];
                                                                                                                    }
                                                                                                                } ?>
...
function approve_record(id, tbl) {
    ...
    $.ajax({
        ...
        data: {
            ...
            action: "approve_long_program_by_incharge",
            id: id,
...
function add_course_dir(program_id, old_course_dir,trng_type, roll) {

    let course_dir = $(`#course_director_${program_id}`).val();
    var action;
    //console.log(roll);
...
function add_asst_course_dir(id, asst_course_dir,course_dir_id, roll) {
    ...
    $.ajax({
        ...
        data: {
            ...
            id: id,
            asst_course_dir: course_dir,
            course_dir_id:course_dir_id,
            roll_id: roll,
            table: "tbl_program_master"
