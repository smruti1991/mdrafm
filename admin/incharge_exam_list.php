                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        switch ($row['status']) {
                                                            case '2':
                                                        ?>
                                                                <button type="button" class="btn btn-info btn-sm" onclick="approve(<?php echo $row['id'] ?>,'Send')">SendTo
                                                                    Director</button>


                                                                <button type="button" class="btn btn-danger ml-2 btn-sm" onclick="reject(<?php echo $row['id'] ?>,'Reject')">Reject</button>
                                                        <?php
                                                                break;
...
<script type="text/javascript">
    function approve(id, title) {
        ...
        $('#m_title').html(`${title} to Director`);
    ...
    function approve_record(id, tbl) {
        ...
        $.ajax({
            ...
            data: {
                ...
                action: "approve_exam_by_incharge",
                id: id,
                table: tbl
            },
