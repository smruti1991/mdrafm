                        ...
                        <div class="card">
                           ...
                           // echo $faculty_id;
                            ...
                            foreach($roll_id as $roll){
                               switch ($roll) {
                                   case '8':
                                        $cd_sql = " AND course_co_officer =".$faculty_id;
                                       break;
                                   case '13':
                                       $cd_sql = " AND asst_course_director =".$faculty_id;
                                       break;
                                   default:
                                       # code...
                                       break;
                              ...
                              // $db->select('tbl_short_program_master',"s.*,c.faculty_id"," s JOIN `tbl_course_director` c ON s.course_director=c.id","s.status != 'draft' ","s.start_date DESC",null );
                                $db->select('tbl_short_program_master',"*",null," status = 'approve' ".$cd_sql," start_date DESC",null );             
