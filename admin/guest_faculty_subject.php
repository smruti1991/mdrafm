                            ...
                            <div class="modal-dialog">
                                <div class="modal-content" style="width:100%; margin:20px ">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="termModalLabel">Guest Faculty Subject</h5>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label><strong> Select Paper</strong></label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary" name="submit" value="Save"
                                            id="save"
                                            onclick="add('Subject','frm_term','tbl_guest_subject')">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="term2" class=" table table-responsive table-striped table-hover" style="width:75%;margin:0px auto" >
                               ...
                               $db = new Database();
                               $count = 0;
                               $db->select('tbl_guest_subject',"*",null,'status = 1','paper_id , subject_name',null);
                              // print_r( $db->getResult());
                               foreach($db->getResult() as $row){
                                   //print_r($row);
                                   $count++
...
function cnfBox(id) {
    ...
    $('#m_footer').empty();
    var html =
        `<input type="button" class="btn btn-danger btn-dlt" value="Delete" onclick="delete_record(${id},'tbl_guest_subject')" />`;
