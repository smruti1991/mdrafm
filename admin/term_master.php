                            ...
                            <div class="modal-dialog">
                                <div class="modal-content" style="width:200%; margin:20px -150px">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="termModalLabel">Term Master</h5>
                                    ...
                                    <form method="post" id="frm_term">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="custom-select mr-sm-2" name="duration_type" id="duration_type">
                                                        <option value="0" selected>Select Duration type</option>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                               <div class="row">
                                    <div class="col-md-4">  
                                       <h4 class="card-title">Term  Master</h4>
                                    </div>
                            ...
                            <div class="card-body">
                               ...
                               $db = new Database();
                               $count = 0;
                               $db->select('tbl_term_master',"*",null,'status = 1',null,null);
                              // print_r( $db->getResult());
                               foreach($db->getResult() as $row){
                                   //print_r($row);
                                   $count++
...
<script type="text/javascript">
    ...
    const termE1 = document.querySelector('#term');
    const durationTypeE1 = document.querySelector('#duration_type');
    const durationE1 = document.querySelector('#duration');

    
    //checkDropdown(syllabusEl);
...
function add(str, frm, tbl) {
    ...
    let isSyllabusValid = checkDropdown(syllabusEl),
        istermValid =  checkTextField(termE1),
        isDurationTypeValid = checkDropdown(durationTypeE1),
