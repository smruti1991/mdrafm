                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-8 text-left">
                                                                                            <select
                                                                                                ...
                                                                                                onchange="add_course_dir(<?php echo $row['id'] ?>,<?php echo $row['course_director_id'] ?>,<?php echo $row1['trng_type'] ?>,8)"
                                                                                                >
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-md-8 ">
                                                                                                    ...
                                                                                                    <select
                                                                                                        ...
                                                                                                        style="height: calc(1em + 0.75rem + 2px);padding:0px"
                                                                                                        onchange="add_asst_course_dir(<?php echo $row['id'] ?>,<?php echo $db->getAsstCourseDirector($row['course_director_id']) ?>,<?php echo $row['course_director_id'] ?>,13)">
