                        ...
                        <div class="card-body">
                            ...
                            <table id="master" class="table">
                                <thead class="" style="background: #315682;color:#fff;">
                                    ...
                                    <th style="width:130px">Section GST Act </th>
                               ...
                               $db->select("tbl_section_gst_act","*",null,"status=1",null,null);
                              ...
                              if($result){
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:100px"><?php echo $row['section']; ?></td>
                                        ...
                                        <td style="width:50px">
                                            ...
                                            <a href="#" class="text-danger" id="<?php echo $row['id']; ?> "
                                                ...
                                                data-placement="top" title="Delete Section"><span class="pcoded-micon"><i
                ...
                <div class="modal-body">
                    <div id="circular_frm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="form-control me-2" type="text" name="section" id="section"
...
function add() {
    ...
    let issectionValid = checkTextField(sectionEl)
    let isFormValid = issectionValid;
    if (isFormValid) {
        ...
        form_data.append("table", "tbl_section_gst_act");
