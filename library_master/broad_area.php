                        ...
                        <div class="card-body">
                            ...
                            <table id="master" class="table">
                                <thead class="" style="background: #315682;color:#fff;">
                                    ...
                                    <th style="width:130px">Broad Area </th>
                              ...
                              if($result){
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:100px"><?php echo $row['broad_area']; ?></td>
                                       
                                        <td style="width:50px">
                                            <a href="#" class="text-primary" id="<?php echo $row['id']; ?> "
                                                data-toggle="tooltip" data-placement="top" title="Edit Broad Area"
                                            ...
                                            <a href="#" class="text-danger" id="<?php echo $row['id']; ?> "
                                                ...
                                                data-placement="top" title="Delete Broad Area"><span class="pcoded-micon"><i
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">ADD NEW Broad Area</h5>
                ...
                <div class="modal-body">
                    <div id="circular_frm">
                        ...
                        <div class="form-group">
                            <div class="row">
                            <div class="col-md-4"><label>Broad Area</label></div>
                            <div class="col-md-6">
                                <input class="form-control me-2" type="text" name="broad_area" id="broadArea"
                                placeholder="Enter Broad Area" required>
...
function add() {
    ...
    let isSubjectValid = checkTextField(broadAreaEl)
    let isFormValid = isSubjectValid;
    if (isFormValid) {
        ...
        form_data.append("table", "tbl_broad_area");
