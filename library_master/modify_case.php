                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-labeled btn-warning" style="margin-right: 2.5rem"
                                id="btn_search">
                                <span class="btn-label" style="margin-right:15px"><i
                                        class="fa fa-search"></i></span>Search
                            </button>
